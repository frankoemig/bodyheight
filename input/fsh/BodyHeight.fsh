...
* ^version = "0.1.0"
* ^abstract = false
* ^type = "http://bodyheight.oemig.de/fhir/StructureDefinition/BodyHeight"
...
* height 1..1 BackboneElement "body height"
  ...
  * unit from http://bodyheight.oemig.de/fhir/ValueSet/BHunits (required)
  * interpretation 0..1 CodeableConcept "interpretation"

* measuringType 0..1 CodeableConcept "measuring type"
* measuringType from http://bodyheight.oemig.de/fhir/ValueSet/MeasuringType (required)
...
* ^url = "http://bodyheight.oemig.de/fhir/CodeSystem/MeasuringType"
* ^version = "0.1.0"

* insert HeaderDetailRules

* ^caseSensitive = false
* ^valueSet = "http://bodyheight.oemig.de/fhir/ValueSet/MeasuringType"
...
* ^url = "http://bodyheight.oemig.de/fhir/ValueSet/MeasuringType"
* ^version = "0.1.0"

* insert HeaderDetailRules

* include codes from system http://bodyheight.oemig.de/fhir/CodeSystem/MeasuringType
...
* ^url = "http://bodyheight.oemig.de/fhir/ValueSet/BHunits"
* ^version = "0.1.0"
